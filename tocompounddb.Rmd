...
excel_path <- "C:/Users/janss/Documents/TFG_GEB/TO_COMPDB/IROA_Map_Plate.xlsx"
...
# Ensure the plot window is large enough
dev.new(width = 10, height = 7)  # Opens a new plotting window with specified size

# Adjust plot margins

combinedasdf<-c(measured_comp[580],measured_comp[581])
# Plot the spectrum
plotSpectra(combinedasdf)
...
spectrum1_data <- extract_spectrum_data(measured_comp[1])
spectrum2_data <- extract_spectrum_data(measured_comp[2])
spectrum3_data <- extract_spectrum_data(measured_comp[3])
...
#final <- merge_three_lists(spectrum1_data,spectrum2_data,spectrum3_data)
interm <- merge_lists(spectrum1_data,spectrum2_data)
final <- merge_lists(interm,spectrum3_data,TRUE)
...
final <- merge_three_lists(spectrum1_data,spectrum2_data,spectrum3_data)
#final <- merge_lists(spectrum1_data,spectrum2_data)
